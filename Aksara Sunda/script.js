...
const originalFlashcards = [
    ...
    { front: "◌ᮤ", back: "<b>Name:</b> Panghulu (Above) | Rarangkén <br><b>Function:</b> Changes 'a' to 'i' <br><b>Example:</b> ᮊ → ᮊᮤ (ki)" },
    { front: "◌ᮥ", back: "<b>Name:</b> Panyuku (Below) | Rarangkén <br><b>Function:</b> Changes 'a' to 'u' <br><b>Example:</b> ᮊ → ᮊᮥ (ku)" },
    { front: "◌ᮦ", back: "<b>Name:</b> Panéléng (Left) | Rarangkén <br><b>Function:</b> Changes 'a' to 'é' <br><b>Example:</b> ᮊ → ᮦᮊ (ké)" },
    { front: "◌ᮧ", back: "<b>Name:</b> Panolong (Left & Right) | Rarangkén <br><b>Function:</b> Changes 'a' to 'o' <br><b>Example:</b> ᮊ → ᮊᮧ (ko)" },
    { front: "◌ᮨ", back: "<b>Name:</b> Pamepet (Above) | Rarangkén <br><b>Function:</b> Changes 'a' to 'e' ('bet') <br><b>Example:</b> ᮊ → ᮊᮨ (ke)" },
    { front: "◌ᮩ", back: "<b>Name:</b> Paneuleung (Below) | Rarangkén <br><b>Function:</b> Changes 'a' to 'eu' <br><b>Example:</b> ᮊ → ᮊᮩ (keu)" },
    { front: "◌ᮁ", back: "<b>Name:</b> Panglayar (Above) | Rarangkén <br><b>Function:</b> Adds final '-r' <br><b>Example:</b> ᮊ → ᮊᮁ (kar)" },
    { front: "◌ᮀ", back: "<b>Name:</b> Panyecek (Above) | Rarangkén <br><b>Function:</b> Adds final '-ng' <br><b>Example:</b> ᮊ → ᮊᮀ (kang)" },
    { front: "◌ᮂ", back: "<b>Name:</b> Pangwisad (Right) | Rarangkén <br><b>Function:</b> Adds final '-h' <br><b>Example:</b> ᮊ → ᮊᮂ (kah)" },
    { front: "◌ᮡ", back: "<b>Name:</b> Panyakra (Below) | Rarangkén <br><b>Function:</b> Inserts '-y-' cluster <br><b>Example:</b> ᮊ → ᮊᮡ (kya)" },
    { front: "◌ᮢ", back: "<b>Name:</b> Panyiku (Below) | Rarangkén <br><b>Function:</b> Inserts '-r-' cluster <br><b>Example:</b> ᮊ → ᮊᮢ (kra)" },
    { front: "◌ᮣ", back: "<b>Name:</b> Pamingkal (Right) | Rarangkén <br><b>Function:</b> Inserts '-l-' cluster <br><b>Example:</b> ᮊ → ᮊᮣ (kla)" },
    { front: "◌᮪", back: "<b>Name:</b> Pamaéh (Right) | Rarangkén <br><b>Function:</b> Silences vowel 'a' <br><b>Example:</b> ᮊ → ᮊ᮪ (k)" },
    // Angka (Numerals)
