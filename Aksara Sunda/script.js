...
const originalFlashcards = [
    ...
    { front: "◌ᮤ", back: "<b>Name:</b> Panghulu | Rarangkén <br><b>Function:</b> Changes 'a' to 'i' <br><b>Example:</b> ᮊ → ᮊᮤ (ki)" },
    { front: "◌ᮥ", back: "<b>Name:</b> Panyuku | Rarangkén <br><b>Function:</b> Changes 'a' to 'u' <br><b>Example:</b> ᮊ → ᮊᮥ (ku)" },
    { front: "◌ᮦ", back: "<b>Name:</b> Panéléng | Rarangkén <br><b>Function:</b> Changes 'a' to 'é' <br><b>Example:</b> ᮊ → ᮦᮊ (ké)" },
    { front: "◌ᮧ", back: "<b>Name:</b> Panolong | Rarangkén <br><b>Function:</b> Changes 'a' to 'o' <br><b>Example:</b> ᮊ → ᮊᮧ (ko)" },
    { front: "◌ᮨ", back: "<b>Name:</b> Pamepet | Rarangkén <br><b>Function:</b> Changes 'a' to 'e' ('bet') <br><b>Example:</b> ᮊ → ᮊᮨ (ke)" },
    { front: "◌ᮩ", back: "<b>Name:</b> Paneuleung | Rarangkén <br><b>Function:</b> Changes 'a' to 'eu' <br><b>Example:</b> ᮊ → ᮊᮩ (keu)" },
    ...
    { front: "◌ᮡ", back: "<b>Name:</b> Panyakra | Rarangkén <br><b>Function:</b> Inserts '-y-' cluster <br><b>Example:</b> ᮊ → ᮊᮡ (kya)" },
    { front: "◌ᮢ", back: "<b>Name:</b> Panyiku | Rarangkén <br><b>Function:</b> Inserts '-r-' cluster <br><b>Example:</b> ᮊ → ᮊᮢ (kra)" },
    { front: "◌ᮣ", back: "<b>Name:</b> Pamingkal | Rarangkén <br><b>Function:</b> Inserts '-l-' cluster <br><b>Example:</b> ᮊ → ᮊᮣ (kla)" },
